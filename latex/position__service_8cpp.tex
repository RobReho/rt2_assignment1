...
This node replies to a request for a random pose (x, y, \textbackslash{}theta) with a random pose within the limits passed in the request. 
...
Server generating a random position\mbox{\Hypertarget{position__service_8cpp_ab65b9ff5368189ad34fe4989d50742e4}\label{position__service_8cpp_ab65b9ff5368189ad34fe4989d50742e4}} 
